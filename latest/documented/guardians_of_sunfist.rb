module Lich
  module Gemstone
    module Societies
      ...
      #   sigil_data = GuardiansOfSunfist['sigil_of_recognition']
      class GuardiansOfSunfist < Gemstone::Society
        ...
        #   sigil = GuardiansOfSunfist['sigil_of_location']
        def self.[](name)
        ...
        #   is_known = GuardiansOfSunfist.known?('sigil_of_contact')
        ...
        #   can_afford = GuardiansOfSunfist.affordable?('sigil_of_minor_bane')
        ...
        #   is_available = GuardiansOfSunfist.available?('sigil_of_defense')
        ...
        # Returns all Guardians of Sunfist sigil metadata entries with evaluated fields.
        # @return [Array<Hash>] An array of sigil metadata hashes with lambdas resolved
        # @example Getting all sigil metadata
