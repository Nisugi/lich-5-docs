module Lich
  module Gemstone
    module Effects
      ...
      # This class includes methods to handle the registration and expiration of effects.
      ...
      class Registry
        ...
        # @yield [key, value] The key-value pair of each effect.
        ...
        # @param effect [String, Regexp] The effect identifier.
