# Lich5 GUI window for managing saved game information.
# This file handles the display and interaction of saved login data in a tabbed format.
# @example Loading the GUI for saved logins
#   load_saved_login_gui
...
# Sets the application theme preference to dark mode if enabled.
...
# If no data is present, it displays a message indicating that.
# @example Checking for saved logins
#   if no_saved_logins?
#     display_no_logins_message
#   end
if @entry_data.empty?
  # Creates a horizontal box for layout.
  # @return [Gtk::Box] The horizontal box for layout.
  ...
  # @return [Gtk::Box] The vertical box for the quick game entry tab.
  ...
  # If true, it initializes the account book for tabbed display.
  # @example Checking tab layout state
  #   if tab_layout_enabled?
  #     initialize_account_book
  #   end
  if @tab_layout_state == true

    # Creates a new notebook for tabbed account management.
    # @return [Gtk::Notebook] The notebook for managing accounts.
    ...
    # Extracts unique account identifiers from the entry data.
    # @return [Array<String>] An array of unique account identifiers.
    ...
    account_array.each { |account|
      ...
      @entry_data.each { |login_info|
        ...
        # Connects the play button to an event handler for launching the game.
        # @example Connecting play button event
        #   connect_play_button_event
  ...
  # Creates a horizontal pane for adding character information.
  # @return [Gtk::Paned] The pane for adding character details.
...
=end
  ...
  # Creates a switch for toggling tab layout settings.
  # @return [Gtk::Switch] The switch for tab layout preference.
  ...
  # Connects the theme switch to an event handler for changing the application theme.
  # @example Connecting theme switch event
  #   connect_theme_switch_event
