...
# This module provides a way to store variables needed by multiple scripts without saving them to the database.
...
module SessionVars
  ...
  # @param name [Symbol] The name of the session variable to retrieve.
  ...
  # @param name [Symbol] The name of the session variable to set.
  # @param val [Object, nil] The value to set, or nil to delete the variable.
  # @return [Object] The value that was set.
  # @example Setting a session variable
  #   SessionVars[:user_id] = 123
  # @example Deleting a session variable
  #   SessionVars[:user_id] = nil
  ...
  # @param arg1 [Symbol] The name of the session variable.
  # @param arg2 [Object, nil] The value to set, or nil to delete the variable.
  # @return [Object, nil] The value of the session variable, or nil if it does not exist.
  # @example Dynamic setting of a session variable
  #   SessionVars.user_id = 123
  # @example Dynamic getting of a session variable
  #   user_id = SessionVars.user_id
