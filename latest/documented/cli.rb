...
module Lich
  module Gemstone
    ...
    # This module contains methods for synchronizing and managing Infomon data.
    # @example Using the Infomon CLI
    #   Lich::Gemstone::Infomon.sync
    module Infomon
      # CLI commands for Infomon
      # Synchronizes Infomon data with the current character's information.
      # @return [void]
      ...
      # This method is destructive and will delete existing data.
      # @return [void]
      # @example Resetting Infomon
      ...
      # @param full [Boolean] Whether to display all information or only non-zero values (default: false)
      # @return [void]
      ...
      # @example Checking if DB refresh is needed
