module Lich
  module Gemstone
    # Represents a spellsong in the Lich Gemstone project.
    # This class manages the duration and effects of bard spells.
    # @example Using the Spellsong class
    ...
    class Spellsong
      ...
      # @raise [NoActiveBardSpellsError] if no active bard spells are found.
      # @example
      #   Lich::Gemstone::Spellsong.sync
      def self.sync
      ...
      # Retrieves the last renewed time.
      ...
      # @note Returns 0.0 if the profession is not Bard.
      # @example
      ...
      # Retrieves the durability of the sonic weapon.
      # @return [Integer] The durability value.
      # @example
      ...
      # Retrieves the cost of renewing spellsongs.
      ...
      # Retrieves the sonic weapon bonus.
      ...
      # Retrieves the mana cost for spells.
      ...
      # Retrieves the fortitude cost for spells.
      ...
      # Retrieves the shield cost for spells.
      ...
      # Retrieves the weapon cost for spells.
      ...
      # Retrieves the armor cost for spells.
      ...
      # Retrieves the sword cost for spells.
