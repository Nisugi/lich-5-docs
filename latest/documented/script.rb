...
# Contains common scripting functionalities.
module Lich
  # Common functionalities for Lich scripts
  # Provides methods and classes for script management.
  module Common
    # module Gemstone
    # Class for handling script bindings
    # @example Creating a scripting instance
    #   scripting = Lich::Common::Scripting.new
    class Scripting
      # Returns a binding for a new script
      # @return [Binding] A new script binding
      def script
        Proc.new {}.binding
      end
    end

    # Returns a binding for a script
    # @return [Binding] A new script binding
    def _script
      Proc.new {}.binding
    end
    ...
    # Provides methods to start, run, and manage script execution.
    ...
    class Script
      ...
      # @example Checking for a script
      #   Script.exists?('my_script')
      ...
      # Opens a file associated with the script
      # @param ext [String] The file extension
      # @param mode [String] The mode to open the file in (default: 'r')
      # @param block [Proc] Optional block for file handling
      # @return [File, nil] The opened file or nil if failed
      # @raise [StandardError] If the file cannot be opened
      # @example Opening a file
      #   file = Script.open_file('txt', 'w')
    ...
    # Inherits from Script and provides execution capabilities.
    ...
    class ExecScript < Script
      ...
      # @raise [StandardError] If the exec script cannot be started
      # @example Starting an exec script
      #   ExecScript.start('my_command')
    ...
    # Inherits from Script and provides wizard-specific functionalities.
    # @example Creating a wizard script
    #   wizard_script = WizardScript.new('wizard_file.wiz')
    class WizardScript < Script
      ...
      # @param file_name [String] The wizard script file name
      # @param cli_vars [Array] Command line variables for the script
      # @return [WizardScript] The initialized wizard script instance
