...
# Lich module for managing updates and utilities for the Lich5 project.
module Lich
  module Util
    module Update
      require 'json'
      ...
      # @param type [String] The command type to process.
      # @return [void]
  ...
  [On demand suggestions]
    ...
    *NOTE* If you use '--snapshot' in '#{$clean_lich_char}autostart' you will create a new
    ...
    "
      ...
      # @param channel [Symbol, String] The channel to resolve ('stable' or 'beta').
      ...
      # @example
      #   Lich::Util::Update.latest_prerelease_tag_greater_than(5, 14)
      ...
      # Finds the latest branch with a name starting with the specified prefix and greater than the stable version.
      # @param prefix [String] The prefix to filter branches.
      # @param stable_major [Integer] The major version of the stable release.
      # @param stable_minor [Integer] The minor version of the stable release.
      # @return [String, nil] The latest branch name or nil if not found.
      # @example
      #   Lich::Util::Update.latest_prefixed_branch_greater_than('pre/beta', 5, 14)
      ...
      # @param tag_or_name [String] The tag or branch name to generate a key from.
      # @return [Gem::Version] The generated version key.
      # @example
      #   Lich::Util::Update.version_key('v5.14.3')
      ...
      # @example
      #   Lich::Util::Update.major_minor_from('v5.14.3')
      ...
      # @param version [String] The version channel to use ('production' or 'beta').
      # @return [void]
      # @example
