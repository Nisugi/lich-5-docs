...
module Lich
  ...
  module Stash
    ...
    # Attempts to execute a command and waits for a condition.
    # @param seconds [Integer] The time to wait before failing (default: 2).
    ...
    # @param bag [String, GameObj] The bag to add the item to.
    ...
    # Wears an item and checks if it is in the inventory.
    ...
    # Equips items from the stash back to the hands.
