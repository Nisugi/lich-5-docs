...
module Lich
  ...
  module DragonRealms
    # DRCC module providing crafting-related methods.
    # @example Using DRCC methods
    #   DRCC.empty_crucible?
    module DRCC
      module_function
      ...
      # Finds a recipe in a book by chapter and match string.
      ...
      # Finds a recipe in a book by chapter, match string, and optional discipline.
      # @param chapter [Integer] The chapter number to turn to.
      # @param match_string [String] The string to match in the recipe.
      # @param book [String] The name of the book to read from.
      ...
      # @return [void]
      # @example
      #   DRCC.find_recipe2(1, 'metal pike', 'book', 'blacksmithing')
      ...
      # @param bag [String] The name of the bag to check.
      # @param bag_items [Array<String>] The items in the bag.
      # @param belt [Hash] The belt containing items.
      # @param skip_exit [Boolean] Whether to skip exit on failure.
      # @return [void]
      # @example
      #   DRCC.get_crafting_item('metal pike', 'backpack', ['metal pike'], belt)
      ...
      # @example
      #   DRCC.stow_crafting_item('metal pike', 'backpack', belt)
      ...
      # @param material [Hash] The material details.
      ...
      # @return [void]
      # @example
      #   DRCC.repair_own_tools(info, tools, 'backpack', bag_items, belt)
      ...
      # @param bag_items [Array<String>] The items in the bag.
      # @param belt [Hash] The belt containing items.
      # @param count [Integer] The number of uses to check for.
      # @return [void]
      # @example
      #   DRCC.check_consumables('oil', 'finisher-room', 10, 'backpack', bag_items, belt)
      ...
      # Retrieves and adjusts tongs based on usage type.
      ...
      # @return [Boolean] true if tongs are successfully adjusted, false otherwise.
      # @example
      #   adjusted = DRCC.get_adjust_tongs?('shovel', 'backpack', bag_items, belt)
      ...
      # @param logbook [String] The name of the logbook.
      ...
      # Orders enchantments for a specified stock item.
      # @param stock_room [String] The room where stock is located.
      ...
      # @return [void]
      # @example
      #   DRCC.order_enchant('stock-room', 5, 123, 'backpack', belt)
      ...
      # Interacts with a fount to retrieve crafting materials.
      # @param stock_room [String] The room where stock is located.
      # @param stock_needed [Integer] The number of stock items needed.
      # @param stock_number [Integer] The stock number to order.
      ...
      # @return [void]
      # @example
      #   DRCC.fount('stock-room', 5, 123, 10, 'backpack', bag_items, belt)
      ...
      # @param bag [String] The name of the bag to check in.
      # @param belt [Hash] The belt containing items.
      # @param info [Hash] Information about the sigil.
      # @return [Boolean] true if sigils are sufficient, false otherwise.
      # @example
      #   if DRCC.check_for_existing_sigil?('fire', 123, 2, 'backpack', belt, info)
      #     puts 'Sufficient sigils found.'
      #   end
      ...
      # @param container [String] The name of the container to check.
      # @param type [String, nil] Optional type of metal to count.
      # @return [Hash, nil] A hash of metal types and their counts, or nil if none found.
      # @example
      #   metals = DRCC.count_raw_metal('forge')
