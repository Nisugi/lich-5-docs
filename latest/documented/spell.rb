=begin
# Core lich file for spell management and for spell related scripts.
...
module Lich
  module Common
    ...
    # This class manages spell attributes, casting, and effects.
    # @example Creating a new spell
    #   spell = Spell.new(xml_spell)
    class Spell
      # List of all spells loaded in the system.
      @@list ||= Array.new
      # Indicates whether the spells have been loaded.
      @@loaded ||= false
      # Lock for managing concurrent spell casting.
      @@cast_lock ||= Array.new
      # List of all bonuses from spells.
      @@bonus_list ||= Array.new
      # List of all costs associated with spells.
      @@cost_list ||= Array.new
      # Mutex for thread-safe loading of spells.
      @@load_mutex = Mutex.new
      @@after_stance = nil
      # Attributes of the spell.
      # @return [Integer] num - The spell number.
      # @return [String] name - The name of the spell.
      # @return [Time] timestamp - The time the spell was created.
      # @return [String] msgup - The message when the spell is cast.
      # @return [String] msgdn - The message when the spell ends.
      # @return [Integer] circle - The circle of the spell.
      # @return [Boolean] active - Whether the spell is currently active.
      # @return [String] type - The type of the spell.
      # @return [String] cast_proc - The procedure to execute when casting.
      # @return [Boolean] persist_on_death - Whether the spell persists after death.
      # @return [String] availability - The availability of the spell.
      ...
      # Stance and channel attributes for the spell.
      # @return [String] stance - The stance required to cast the spell.
      # @return [String] channel - The channeling status of the spell.
      ...
      # Initializes a new spell from XML data.
      ...
      # Sets the after stance value.
      # @param val [String] The stance to set after casting.
      # @return [void]
      def Spell.after_stance=(val)
        @@after_stance = val
      end

      # Gets the after stance value.
      # @return [String] The current after stance value.
      def Spell.after_stance
        @@after_stance
      end

      # Loads spells from a specified XML file.
      ...
      # @example
      #   Spell.load('path/to/spell_file.xml')
      ...
      # @param val [Integer, String, Spell] The spell number, name, or Spell object.
      ...
      # @return [Float] The calculated time.
      # @example
      #   time = spell.time_per_formula(caster: 'self')
      ...
      # Calculates the time required for a spell based on the formula.
      # @param options [Hash] Options for calculating time.
      # @return [Float] The calculated time.
      # @example
      #   time = spell.time_per(caster: 'self')
      ...
      # @param val [Float] The time left for the spell.
      # @return [void]
      def timeleft=(val)
        @timeleft = val
        @timestamp = Time.now
      ...
      # @return [Float] The time left for the spell.
      # @example
      #   remaining_time = spell.timeleft
      def timeleft
      ...
      # Retrieves the remaining time in minutes for the spell.
      # @return [Float] The remaining time in minutes.
      # @example
      #   minutes_left = spell.minsleft
      def minsleft
        self.timeleft
      end

      # Retrieves the remaining time in seconds for the spell.
      # @return [Float] The remaining time in seconds.
      # @example
      #   seconds_left = spell.secsleft
      def secsleft
        self.timeleft * 60
      end

      # Sets the active status of the spell.
      # @param val [Boolean] The active status to set.
      # @return [void]
      def active=(val)
        @active = val
      end
      ...
      # @param val [Boolean] True if the spell requires an incantation, false otherwise.
      def incant=(val)
        @no_incant = !val
      end
      ...
      # @param options [Hash] Options for checking duration.
      # @return [Float] The maximum duration of the spell.
      ...
      # Retrieves the remaining time formatted as time.
      ...
      # @return [Boolean] True if the spell is affordable, false otherwise.
      ...
      # @param results_of_interest [Regexp, nil] Regex for results to capture.
      ...
      # @return [String, false] The result of the cast or false on failure.
      # @raise [StandardError] If there is an error during casting.
      # @example
      #   result = spell.cast(target)
      ...
      # @param results_of_interest [Regexp, nil] Regex for results to capture.
      # @param force_stance [Boolean, nil] Whether to force a specific stance.
      # @return [String, false] The result of the channel or false on failure.
      ...
      # @param results_of_interest [Regexp, nil] Regex for results to capture.
      # @param force_stance [Boolean, nil] Whether to force a specific stance.
      # @return [String, false] The result of the evoke or false on failure.
      ...
      # @param results_of_interest [Regexp, nil] Regex for results to capture.
      # @param force_stance [Boolean, nil] Whether to force a specific stance.
      # @return [String, false] The result of the incantation or false on failure.
      ...
      # Retrieves the bonuses associated with the spell.
      # @return [Hash] A hash of bonuses.
      def _bonus
        @bonus.dup
      end

      # Retrieves the costs associated with the spell.
      # @return [Hash] A hash of costs.
      def _cost
        @cost.dup
      end

      # Handles missing methods for bonus and cost retrieval.
      # @param args [Array] The arguments passed to the method.
      # @return [Integer, Hash] The value of the bonus or cost, or raises NoMethodError.
      ...
      # @return [Boolean] True if the spell should clear, false otherwise.
      def clear_on_death
        !@persist_on_death
      end
