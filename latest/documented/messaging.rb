...
module Lich
  # Provides various messaging capabilities for Lich.
  # Entries added here should always be accessible from Lich::Messaging.feature namespace.
  # @example Accessing messaging features
  #   Lich::Messaging.xml_encode('message')
  module Messaging
    # Encodes a message to XML format.
    # @param msg [String] The message to encode.
    # @return [String] The encoded XML message.
    ...
    #   bold_msg = Lich::Messaging.monsterbold('A fierce monster appears!')
    ...
    # @param window [String] The type of window (default: 'familiar').
    # @param encode [Boolean] Whether to encode the message (default: true).
    # @return [void]
    # @example Wrapping a message in a stream window
    #   Lich::Messaging.stream_window('Hello!', 'speech')
    ...
    # Formats a message with specific type and color coding.
    # @param type [String] The type of message (default: 'info').
    # @param msg [String] The message to format.
    # @param cmd_link [String, nil] Optional command link.
    # @param encode [Boolean] Whether to encode the message (default: true).
    # @return [String] The formatted message.
