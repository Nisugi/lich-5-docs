module Lich
  module Gemstone
    # Represents a ready list for managing equipped items in the game.
    ...
    class ReadyList
      ...
      # The original list of ready item types.
      # This constant defines the types of items that can be ready.
      ORIGINAL_READY_LIST = [:shield, :weapon, :secondary_weapon, :ranged_weapon, :ammo_bundle, :ammo2_bundle, :sheath, :secondary_sheath, :wand]
      # The original list of store item types.
      # This constant defines the types of items that can be stored.
      ...
      # Class methods for the ReadyList class.
      class << self
        # Returns the current ready list.
        # @return [Hash] The current ready list with item types as keys and their values.
        def ready_list
          @ready_list
        end

        # Returns the current store list.
        # @return [Hash] The current store list with item types as keys and their values.
        def store_list
          @store_list
        end
        ...
        # @note This method sets the checked status to true after execution.
