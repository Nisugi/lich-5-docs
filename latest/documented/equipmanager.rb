module Lich
  module DragonRealms
    # Manages the equipment for the DragonRealms game.
    ...
    class EquipmentManager
      ...
      # @example
      #   removed_items = manager.remove_gear_by { |item| item.worn? }
      ...
      # @example
      #   items = manager.desc_to_items(['a shiny sword', 'a leather armor'])
      ...
      # @param worn_items [Array<Item>] The worn items.
      # @return [Array<Item>] The list of removed items.
      # @example
      ...
      # @example
      #   worn = manager.worn_items(['a shiny sword', 'a leather armor'])
      def worn_items(list)
      ...
      # @example
      #   success = manager.wield_weapon_offhand('a shiny sword')
      ...
      # @return [Boolean] True if the weapon was successfully wielded, false otherwise.
      # @example
      #   success = manager.wield_weapon('a shiny sword')
      ...
      # Checks if an item can be obtained.
      ...
      # Retrieves verb data for an item.
      ...
      # @example
      #   success = manager.turn_to_weapon?('a shiny sword', 'a shiny dagger')
      ...
      # @example
      #   success = manager.swap_to_skill?('a shiny sword', 'heavy edged')
      ...
      # @return [void]
      # @example
      #   manager.unload_weapon('a shiny sword')
      ...
      # Stows a weapon into the inventory.
      # @param description [String, nil] The description of the weapon to stow.
      # @return [void]
      # @example
      #   manager.stow_weapon('a shiny sword')
      ...
      # Helper method to perform stowing actions for weapons.
      # @param action [String] The action command to perform.
      # @param weapon_name [String] The name of the weapon to stow.
      # @param accept_strings [Array<String>] The success messages to match against.
      # @return [void]
      # @example
      #   manager.stow_helper('stow my shiny sword', 'shiny sword', ['You put', 'You should unload'])
