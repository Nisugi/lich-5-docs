  ...
  module Gemstone
    module Societies
      ...
      class CouncilOfLight < Gemstone::Society
        ...
        #   known = CouncilOfLight.known?('sign_of_signal')
        ...
        #   CouncilOfLight.use('sign_of_recognition')
        ...
        #   affordable = CouncilOfLight.affordable?('sign_of_signal')
        ...
        # Mana costs are ignored.
        # @return [Integer] Total spirit points that will be lost when applicable signs expire.
        # @example Calculating pending spirit loss
        ...
        #   available = CouncilOfLight.available?('sign_of_signal')
