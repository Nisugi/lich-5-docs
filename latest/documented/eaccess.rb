...
module Lich
  ...
  #   include Lich::Common
  module Common
    # Handles the EAccess functionality for the Lich project
    # @example Using EAccess
    ...
    module EAccess
      ...
      # @return [Boolean] true if the certificates match
      # @raise [StandardError] if the certificates do not match
      # @example Verifying the PEM certificate
      ...
      # @example Creating a socket connection
      ...
      # @return [String, Array<Hash>] An error message or login information
      # @raise [StandardError] if authentication fails
      # @example Authenticating a user
      #   login_info = Lich::Common::EAccess.auth(password: 'secret', account: 'user123')
