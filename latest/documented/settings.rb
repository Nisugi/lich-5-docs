...
module Lich
  module Common
    ...
    # Provides a settings management system for the Lich project.
    # This module handles logging, settings retrieval, and storage.
    # @example Accessing settings
    #   settings = Lich::Common::Settings.root_proxy_for('example_scope')
    module Settings
      ...
      # Log level constant indicating no logging.
      LOG_LEVEL_NONE = 0
      # Log level constant indicating error logging.
      LOG_LEVEL_ERROR = 1
      # Log level constant indicating informational logging.
      LOG_LEVEL_INFO = 2
      # Log level constant indicating debug logging.
      LOG_LEVEL_DEBUG = 3

      # The current log level for the Settings module.
      @@log_level = LOG_LEVEL_NONE # Default: logging disabled
      # The prefix used in log messages from the Settings module.
      ...
      # @return [Integer] The numeric log level set
      ...
      # @param message_proc [Proc] A proc that generates the log message
      # @return [void]
      ...
      # Reattaches a proxy to a live object based on the current path.
      ...
      @settings_cache = {}
      # The default scope identifier for settings.
      DEFAULT_SCOPE = ":".freeze
      # Indicates if safe navigation is currently active.
      ...
      # Unwraps any proxies in the given data structure.
      ...
      # @param scope [String] The scope to retrieve settings for; defaults to DEFAULT_SCOPE
      # @return [Object] The current settings data
      # @example Getting current script settings
      #   settings = Lich::Common::Settings.current_script_settings('example_scope')
      ...
      # Saves the given data to the database for the current script and scope.
      # @param data_to_save [Object] The data to save
      # @param scope [String] The scope for which to save the data; defaults to DEFAULT_SCOPE
      # @return [void]
      # @note If the script name is nil or empty, the save operation is aborted.
      # @example Saving data to the database
      #   Lich::Common::Settings.save_to_database(my_data, 'example_scope')
      ...
      # Refreshes the settings data for the specified scope.
      ...
      #   refreshed_settings = Lich::Common::Settings.refresh_data('example_scope')
      ...
      # Navigates to a specific path within the settings structure.
      # @param create_missing [Boolean] Whether to create missing segments; defaults to true
      # @param scope [String] The scope to navigate within; defaults to DEFAULT_SCOPE
      # @return [Array] An array containing the target object and the root settings
      # @example Navigating to a path
      #   target, root = Lich::Common::Settings.navigate_to_path(true, 'example_scope')
      ...
      # @param scope [String] The scope to set the setting for; defaults to DEFAULT_SCOPE
      # @param name [String] The name of the setting to set
      # @param value [Object] The value to set for the setting
      # @return [void]
      # @example Setting a script setting
      #   Lich::Common::Settings.set_script_settings('example_scope', 'setting_name', 'setting_value')
      ...
      #   value = Lich::Common::Settings['setting_name']
      def self.[](name)
      ...
      #   Lich::Common::Settings['setting_name'] = 'new_value'
      def self.[]=(name, value)
        scope_to_use = DEFAULT_SCOPE
      ...
      #   value = Lich::Common::Settings.get_scoped_setting('example_scope', 'setting_name')
      ...
      # Wraps a value in a SettingsProxy if it is a container.
      ...
      # @return [Object] The wrapped value or the original value
      # @example Wrapping a value
      #   wrapped_value = Lich::Common::Settings.wrap_value_if_container(my_value, 'example_scope', ['path'])
      ...
      #   settings_hash = Lich::Common::Settings.to_hash('example_scope')
