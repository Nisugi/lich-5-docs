=begin
# Core lich file that defines the data extracted from SIMU's XML.
#
...
# The main module for Lich functionality.
module Lich
  # Common functionality for Lich modules.
  module Common
    ...
    class XMLParser
      ...
      # Indicates whether to send fake tags.
      ...
      # @return [Hash] A hash of active spells and their details.
      # @example
      ...
      # Checks if it's safe to respond to the game.
      ...
      # Creates a binary string representation of wounds.
      ...
      # Creates a binary string representation of scars.
      ...
      # Constant representing a decade in seconds.
      DECADE = 10 * 31_536_000

      # Parses a PSM3 progress bar element.
      ...
      # Retrieves active spells from the deprecated spellfront.
