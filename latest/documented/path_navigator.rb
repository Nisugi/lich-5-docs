...
module Lich
  module Common
    ...
    class PathNavigator
      ...
      #
      # This method clears the current path.
      # @return [void]
      ...
      #
      # This method clears the current path and returns the specified value.
      ...
      #   result = navigator.reset_path_and_return('some_value')
      ...
      # Returns [target, root]
      #
      # This method navigates through the path structure and retrieves the target node and root object.
      # @param script_name [String] the script namespace (e.g., Script.current.name)
      # @param create_missing [Boolean] whether to create intermediate containers
      # @param scope [String] settings scope (e.g., 'GS3:CharName')
      # @param path [Array, nil] path segments; integers index arrays, symbols/strings index hashes
      ...
      #   target, root = navigator.navigate_to_path('script_name', true, 'scope', ['level1', 'level2'])
