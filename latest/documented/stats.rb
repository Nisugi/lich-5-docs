...
module Lich
  # Contains functionality related to the Gemstone game
  # @example Accessing Gemstone stats
  #   Lich::Gemstone::Stats.profession
  module Gemstone
    module Stats
      # Retrieves the race stat
      # @return [String] The race of the character
      # @example Getting the race
      #   Lich::Gemstone::Stats.race
      def self.race
        Infomon.get("stat.race")
      end

      # Retrieves the profession stat
      # @return [String] The profession of the character
      # @example Getting the profession
      #   Lich::Gemstone::Stats.profession
      def self.profession
        Infomon.get("stat.profession")
      end

      # Retrieves the profession stat (alias for profession)
      # @return [String] The profession of the character
      # @example Getting the profession using alias
      #   Lich::Gemstone::Stats.prof
      def self.prof
        self.profession
      end

      # Retrieves the gender stat
      # @return [String] The gender of the character
      # @example Getting the gender
      #   Lich::Gemstone::Stats.gender
      def self.gender
        Infomon.get("stat.gender")
      end

      # Retrieves the age stat
      # @return [Integer] The age of the character
      # @example Getting the age
      ...
      @@stats.each do |stat|
        # Dynamically defines methods for each stat
        # @param stat [Symbol] The stat to define a method for
        # @return [OpenStruct] Contains value, bonus, and enhanced stats
        # @example Accessing a stat
      ...
      # @example Getting experience points
      ...
      # Serializes the character stats into an array
      # @return [Array] An array of serialized stats
      # @example Serializing stats
