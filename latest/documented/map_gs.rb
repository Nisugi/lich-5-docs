module Lich
  module Common
    class Map
      ...
      # @param paths [Array<String>] The paths leading from this map.
      # @param uid [Array<Integer>] Unique identifiers associated with the map.
      ...
      # @param wayto [Hash<String, String>] Directions to other maps.
      # @param timeto [Hash<String, Float>] Time taken to reach other maps.
      ...
      # @param unique_loot [Array<String>, nil] Unique loot available in the map.
      ...
      # @return [Integer, nil] The ID of the previous room or nil if not set.
      ...
      # Inspects the map instance.
      # @return [String] A string containing the instance variables and their values.
      def inspect
      ...
      # @return [Map, nil] The map instance or nil if not found.
      def Map.[](val)
        Map.load unless @@loaded
      ...
      # @return [String, nil] The current location or nil if not set.
      ...
      # Retrieves the previous map instance.
      # @return [Map, nil] The previous map instance or nil if not set.
      def Map.previous
      ...
      # @return [Integer, nil] The previous UID or nil if not set.
      def Map.previous_uid
        return XMLData.previous_nav_rm
      end

      # Retrieves the current map instance.
      # @return [Map, nil] The current map instance or nil if not set.
      ...
      # @return [Map, nil] The newly set current map instance or nil if not found.
      ...
      # Sets the fuzzy room ID.
      # @param id [Integer] The ID of the room to set as fuzzy.
      # @return [Map, nil] The newly set fuzzy room instance or nil if not found.
      ...
      # Matches multiple IDs to find a valid room ID.
      # @param ids [Array<Integer>] The array of IDs to match.
      # @return [Integer, nil] The matched ID or nil if no match found.
      ...
      # @return [Map, nil] The matched map instance or nil if not found.
      ...
      # @return [Map, nil] The current or newly created map instance.
      ...
      # Retrieves the unique locations from all maps.
      ...
      # Retrieves the unique images from all maps.
      ...
      # Retrieves the unique tags from all maps.
      ...
      # Retrieves the unique IDs mapping.
      # @return [Hash<Integer, Array<Integer>>] A hash mapping UIDs to their corresponding IDs.
      ...
      # @return [Array<Integer>] An array of IDs associated with the UID.
      def Map.ids_from_uid(n); return (@@uids[n].nil? ? [] : @@uids[n]); end

      # Adds a mapping from a UID to a map ID.
      # @param uid [Integer] The UID to add.
      # @param id [Integer] The map ID to associate with the UID.
      ...
      # Clears all maps and resets the state.
      ...
      # @return [Boolean] True if the reload operation was successful.
      def Map.reload
        Map.clear
        Map.load
      end
      ...
      # @param filename [String, nil] The filename to load from, or nil to load default files.
      ...
      # @param filename [String, nil] The filename to load from, or nil to load default JSON files.
      # @return [Boolean] True if the load operation was successful.
      ...
      # @param filename [String, nil] The filename to load from, or nil to load default DAT files.
      # @return [Boolean] True if the load operation was successful.
      ...
      # @param filename [String] The filename to save the map data to.
      ...
      # Estimates the time to traverse a series of rooms.
      # @param array [Array<Integer>] The array of room IDs to traverse.
      ...
      # @param destination [Integer, nil] The destination room ID.
    ...
    # Inherits from Map and can have additional properties or methods.
    ...
    class Map
      ...
      # Retrieves the Y coordinate of the map image.
      ...
      # Retrieves the size of the map image.
      # @return [Integer, nil] The size of the map image or nil if not set.
      def map_roomsize; return @image_coords.nil? ? nil : image_coords[2] - image_coords[0]; end
      # Retrieves geographical information about the map.
