  ...
  module Gemstone
    module Societies
      ...
      class OrderOfVoln < Gemstone::Society
        ...
        #   symbol = OrderOfVoln['symbol_of_blessing']
        def self.[](name)
        ...
        #   known = OrderOfVoln.known?('symbol_of_courage')
        ...
        #   OrderOfVoln.use('symbol_of_blessing')
        ...
        #   affordable = OrderOfVoln.affordable?('symbol_of_protection')
