...
module Lich
  ...
  # Finds the location of the game launcher based on the front-end.
  # @param fe [String] The front-end identifier (e.g., 'wizard', 'stormfront').
  # @return [String, nil] The location of the launcher or nil if not found.
  # @example Finding the launcher location
  ...
  # Logs a deprecation warning for using old objects.
  ...
  # Searches for the hosts file in the system.
  # @return [String, false] The path to the hosts file or false if not found.
  ...
  # Modifies the hosts file to include a game host entry.
  ...
  # @example Modifying the hosts file
  #   Lich.modify_hosts('game.example.com')
  ...
  # @return [nil]
  # @example Restoring the hosts file
  #   Lich.restore_hosts
  ...
  # Sets the inventory boxes state for a player.
  # @param player_id [Integer] The ID of the player.
  # @param enabled [Boolean] Whether to enable or disable inventory boxes.
  # @return [nil]
  # @example Setting inventory boxes
  ...
  # Retrieves the Windows launch method setting.
  ...
  # @return [nil]
  # @example Setting the launch method
  ...
  # Breaks the game host and port back to their original values.
  ...
  # @return [Boolean] True if tracking autosort state is enabled, false otherwise.
  ...
  # @param val [Boolean] Whether to enable or disable tracking autosort state.
  # @return [nil]
  ...
  # @return [Boolean] True if tracking dark mode is enabled, false otherwise.
  ...
  # @param val [Boolean] Whether to enable or disable tracking dark mode.
  # @return [nil]
  ...
  # @return [Boolean] True if tracking layout state is enabled, false otherwise.
  ...
  # @param val [Boolean] Whether to enable or disable tracking layout state.
  # @return [nil]
