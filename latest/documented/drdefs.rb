# Lich module
# This module contains methods related to the DragonRealms game.
...
module Lich
  module DragonRealms
    ...
    # @param denomination [String] The type of denomination (platinum, gold, silver, bronze).
    ...
    # @example
    #   convert2plats(10000) # => '1 platinum'
    ...
    # Finds player characters in the room.
    ...
    # Finds player characters that are lying down in the room.
    # @param room_players [String] The string containing room players.
    ...
    # Finds player characters that are sitting in the room.
    # @param room_players [String] The string containing room players.
    ...
    # Finds all non-player characters (NPCs) in the room.
    # @param room_objs [String] The string containing room objects.
    # @return [Array<String>] An array of NPC names.
    # @example
    #   find_all_npcs('You also see a dragon, a knight.') # => ['a dragon', 'a knight']
    ...
    # @param npc_string [Array<String>] The array of NPC names to clean.
    # @return [Array<String>] An array of cleaned NPC names.
    # @example
    #   clean_npc_string(['<pushBold/>a dragon<popBold/>', '<pushBold/>a knight<popBold/>']) # => ['a dragon', 'a knight']
    ...
    # @example
    #   remove_html_tags('<pushBold/>a dragon<popBold/>') # => 'a dragon'
    ...
    # Extracts the last creature name from the text after 'and'.
    # @param text [String] The text containing creature names.
    # @return [String] The last creature name extracted.
    # @example
    #   extract_last_creature('a dragon and a knight') # => 'a knight'
    ...
    # @example
    #   extract_final_name('a dragon') # => 'dragon'
    ...
    # @example
    #   add_ordinals_to_duplicates(['dragon', 'dragon']) # => ['dragon', '1st dragon']
    ...
    # Finds and cleans object names in the room.
    # @param room_objs [String] The string containing room objects.
    # @return [Array<String>] An array of cleaned object names.
    # @example
    #   find_objects('You also see <pushBold/>a dragon<popBold/>.') # => ['a dragon']
