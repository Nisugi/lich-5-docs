...
module Lich
  ...
  module Gemstone
    ...
    # Dynamic methods are generated for each weapon technique using its short and long name.
    # @example
    #   Weapon.barrage # returns the rank of the barrage technique
    module Weapon
      ...
      # @return [Array<Hash>] Each hash contains :long_name, :short_name, :cost
      # @example
      #   Weapon.weapon_lookups # returns an array of weapon techniques with their metadata
      ...
      # @return [Boolean] True if buff is already active
      # @example
      #   Weapon.buff_active?("volley") => true # if the buff is active
