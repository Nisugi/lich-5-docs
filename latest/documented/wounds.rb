  ...
  module Gemstone
    ...
    class Wounds < Gemstone::CharacterStatus # GameBase::CharacterStatus
      class << self
        ...
        # This constant is used to define accessor methods for each body part.
        BODY_PARTS = {
          leftEye: ['leye'],
          rightEye: ['reye'],
          head: [],
        ...
        # @return [Integer, nil] The maximum wound level among the left arm, right arm, left hand, and right hand.
        # @example
        ...
        # @return [Integer, nil] The maximum wound level among the arms and legs.
        # @example
        ...
        # Returns the maximum wound level for the torso.
        # @return [Integer, nil] The maximum wound level among the torso body parts.
        # @example
        ...
        # @example
        #   wound_level = wounds.wound_level(:leftArm)
