...
module Lich
  ...
  module DragonRealms
    ...
    module DRCI
      ...
      # Patterns for failure messages when dropping trash.
      ...
      # Patterns for verbs associated with worn trashcans.
      ...
      # Patterns for failure messages when retrieving items.
      ...
      # Patterns for failure messages when wearing items.
      ...
      # Patterns for failure messages when tying items.
      ...
      # Patterns for failure messages when untieing items.
      ...
      # Patterns for failure messages when removing items.
      ...
      # Patterns for failure messages when putting away items.
      ...
      # Patterns for failure messages when stowing items.
      STOW_ITEM_FAILURE_PATTERNS = [
        *GET_ITEM_FAILURE_PATTERNS,
        *PUT_AWAY_ITEM_FAILURE_PATTERNS,
      ]

      # Patterns for retry messages when stowing items.
      ...
      # Patterns for failure messages when rummaging.
      ...
      # Patterns for failure messages when tapping.
      ...
      # Patterns for failure messages when opening containers.
      ...
      # Patterns for failure messages when closing containers.
      ...
      # Patterns for messages indicating a closed container.
      ...
      # Patterns for failure messages when lowering items.
      ...
      # Patterns for failure messages when lifting items.
      ...
      # Patterns for failure messages when giving items.
      ...
      # Disposes of a specified trash item.
      ...
      # @note If the item is not held, it will not be disposed of.
      # @example
      #   dispose_trash('apple')
      ...
      # @return [Boolean] Returns true if the item is worn, false otherwise.
      # @example
      ...
      # Checks if an item exists in the inventory or specified container.
      # @param item [String] The item to check.
      # @param container [String, nil] The container to check inside.
      # @return [Boolean] Returns true if the item exists, false otherwise.
      # @example
      #   item_exists = exists?('shield')
      ...
      # @return [String, nil] Returns the response from tapping the item, or nil if the item is not specified.
      # @example
      #   response = tap('sword')
      ...
      # @example
      #   is_in_left_hand = in_left_hand?('sword')
      ...
      # @example
      #   is_in_right_hand = in_right_hand?('shield')
      ...
      # @return [Boolean] Returns true if the item is in the specified hand(s), false otherwise.
      # @example
      #   is_in_hand = in_hand?('potion', 'left')
      ...
      # @return [Boolean] Returns true if the item is found, false otherwise.
      # @example
      #   has_item = have_item_by_look?('gem', 'pouch')
      ...
      # Counts the parts of a specified item.
      # @param item [String] The item to count parts of.
      # @return [Integer] The number of parts left.
      # @example
      #   parts_count = count_item_parts('wood')
      ...
      # @return [Integer] The number of items in the inferred container.
      # @example
      #   item_count = count_items('arrows')
      ...
      # @example
      #   count = count_items_in_container('scroll', 'bag')
      ...
      # @param container [String] The container to check.
      # @return [Integer] The number of additional lockpicks the container can hold.
      # @example
      #   lockpick_count = count_lockpick_container('lockpick ring')
      ...
      # @param container [String] The container to check.
      # @return [Array] An array of box descriptions.
      # @example
      ...
      # @param container [String] The container to check.
      # @return [Array] An array of scroll descriptions.
      # @example
      #   scrolls = get_scroll_list_in_container('scroll case')
      ...
      # Counts the current material item count in a necro material stacker.
      # @param necro_stacker [String] The necro stacker to check.
      # @return [Integer] The current item count in the stacker.
      # @example
      ...
      # @return [Integer] The total count of boxes.
      # @example
      ...
      # Gets an item if it is not already held.
      ...
      # Gets an item from a specified container or the room.
      # @param item [String] The item to get.
      # @param container [String, nil] The container to get the item from.
      ...
      # Safely gets an item from a specified container.
      # @param item [String] The item to get.
      # @param container [String, nil] The container to get the item from.
      # @return [Boolean] Returns true if the item was successfully retrieved.
      # @example
      #   success = get_item_safe?('gem', 'pouch')
      ...
      # Gets an item, optionally from a specific container.
      # If no container specified then generically grabs from the room/your person.
      # Gets an item from a specified container without safety checks.
      # @param item [String] The item to get.
      # @param container [String, nil] The container to get the item from.
      # @return [Boolean] Returns true if the item was successfully retrieved.
      # @example
      #   success = get_item_unsafe('amulet', 'chest')
      ...
      # Gets an item from the eddy portal, ensuring it is open first.
      # @param item [String] The item to get.
      ...
      # @return [Boolean] Returns true if the item was successfully tied, false otherwise.
      # @example
      ...
      # @return [Boolean] Returns true if the item was successfully untied, false otherwise.
      # @example
      ...
      # @return [Boolean] Returns true if the item was successfully worn, false otherwise.
      # @example
      ...
      # Safely wears an item from your hands.
      # @param item [String] The item to wear.
      # @return [Boolean] Returns true if the item was successfully worn, false otherwise.
      # @example
      ...
      # Wears an item from your hands.
      # Wears an item from your hands without safety checks.
      # @param item [String] The item to wear.
      # @return [Boolean] Returns true if the item was successfully worn, false otherwise.
      # @example
      ...
      # the item name is prefixed with 'my' qualifier.
      # Safely removes an item you're wearing.
      # @param item [String] The item to remove.
      # @return [Boolean] Returns true if the item was successfully removed, false otherwise.
      # @example
      ...
      # Removes an item you're wearing.
      # Removes an item you're wearing without safety checks.
      # @param item [String] The item to remove.
      # @return [Boolean] Returns true if the item was successfully removed, false otherwise.
      # @example
      ...
      # @return [Boolean] Returns true if the item was successfully stowed, false otherwise.
      # @example
      ...
      # Safely stows an item into its default container.
      # @param item [String] The item to stow.
      # @return [Boolean] Returns true if the item was successfully stowed, false otherwise.
      # @example
      ...
      # Stows an item into its default container without safety checks.
      # @param item [String] The item to stow.
      # @return [Boolean] Returns true if the item was successfully stowed, false otherwise.
      # @example
      ...
      # @return [Boolean] Returns true if the item was successfully lowered, false otherwise.
      # @example
      ...
      # @param stow [Boolean, String] If true, stows the item; if a string, puts it away in that container.
      # @return [Boolean] Returns true if the item was successfully lifted, false otherwise.
      # @example
      ...
      # @param container [String] The container to check.
      # @return [Boolean, nil] Returns true if the container is empty, false if not, or nil if undetermined.
      # @example
      ...
      # Gets a list of items from the inventory by type.
      # @param type [String] The type of items to retrieve (e.g., 'combat').
      # @param line_count [Integer] The number of lines to check in the inventory output.
      # @return [Array] An array of item descriptions.
      # @example
      #   items = get_inventory_by_type('combat')
      ...
      # Rummages through a container to get its contents.
      # @param container [String] The container to rummage through.
      # @return [Array, nil] An array of item descriptions or nil if unable to determine.
      # @example
      #   contents = rummage_container('chest')
      ...
      # Looks inside a container to get its contents.
      # @param container [String] The container to look in.
      # @return [Array, nil] An array of item descriptions or nil if unable to determine.
      # @example
      #   contents = look_in_container('box')
      ...
      # Puts away an item into a specified container or default stow location.
      # @param item [String] The item to put away.
      # @param container [String, nil] The container to put the item in.
      # @return [Boolean] Returns true if the item was successfully put away, false otherwise.
      # @example
      #   success = put_away_item?('gem', 'pouch')
      ...
      # the container argument is prefixed with 'my' qualifier.
      # Safely puts away an item into a specified container.
      # @param item [String] The item to put away.
      # @param container [String, nil] The container to put the item in.
      # @return [Boolean] Returns true if the item was successfully put away, false otherwise.
      # @example
      #   success = put_away_item_safe?('ring', 'box')
      ...
      # Puts away an item into a specified container without safety checks.
      # @param item [String] The item to put away.
      # @param container [String, nil] The container to put the item in.
      # @param preposition [String] The preposition to use (default is 'in').
      # @return [Boolean] Returns true if the item was successfully put away, false otherwise.
      # @example
      #   success = put_away_item_unsafe?('amulet', 'chest')
      ...
      # @return [Boolean] Returns true if the container was successfully opened, false otherwise.
      # @example
      ...
      # @return [Boolean] Returns true if the container was successfully closed, false otherwise.
      # @example
      ...
      # @param item [String, nil] The item to give (optional).
      # @return [Boolean] Returns true if the item was successfully given, false otherwise.
      # @example
      #   success = give_item?('friend', 'gem')
      ...
      # @return [String, false] Returns the name of the player whose offer was accepted, or false if not accepted.
      # @example
      #   player_name = accept_item?
      def accept_item?
      ...
      # @example
      #   success = swap_out_full_gempouch?('shiny', 'gem pouch')
      ...
      # @param gem_pouch_noun [String] The noun of the gem pouch.
      # @param full_pouch_container [String, nil] The container for the full pouch.
      # @return [Boolean] Returns true if the pouch was successfully removed and stowed, false otherwise.
      # @example
      #   success = remove_and_stow_pouch?('shiny', 'gem pouch')
      ...
      # @param gem_pouch_adjective [String] The adjective of the gem pouch.
      # @param gem_pouch_noun [String] The noun of the gem pouch.
      # @return [Boolean] Returns true if the pouch was successfully tied, false otherwise.
      # @example
      #   success = tie_gem_pouch('shiny', 'gem pouch')
      ...
      # @return [void]
      # @example
      #   fill_gem_pouch_with_container('shiny', 'gem pouch', 'box')
