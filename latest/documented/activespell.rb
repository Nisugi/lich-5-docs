module Lich
  module Gemstone
    # Provides functionality for managing active spells and their durations.
    # This module addresses spell timing discrepancies and updates spell durations.
    # @example Using ActiveSpell
    ...
    module ActiveSpell
      ...
      # @example Checking if durations should be shown
      #   if ActiveSpell.show_durations?
      #     puts 'Showing durations'
      #   end
      ...
      # @param spell_check [Hash] A hash of active spells to check (default is XMLData.active_spells)
      ...
      #   time_requested = ActiveSpell.block_until_update_requested
