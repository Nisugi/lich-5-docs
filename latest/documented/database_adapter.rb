module Lich
  module Common
    ...
    # Database adapter to separate database concerns
    #
    # This class handles the interaction with the database, including setup, retrieval, and storage of settings.
    ...
    class DatabaseAdapter
      ...
      # @raise [Sequel::DatabaseError] If there is a database error during saving.
