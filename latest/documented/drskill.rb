module Lich
  module DragonRealms
    # Represents a skill in DragonRealms.
    # This class manages skill data, including ranks, experience, and skillsets.
    ...
    class DRSkill
      ...
      # @return [DRSkill]
      # @example
      #   skill = DRSkill.new('Evasion', 10, 100, 50)
      ...
      # This method clears the list of gained skills and resets the baseline for all skills.
      # @return [void]
      # @example
      #   DRSkill.reset
      def self.reset
      ...
      # @param val [String] The name of the skill to check.
      # @return [Float] The amount of ranks gained since the last baseline reset.
      # @example
      #   exp_gained = DRSkill.gained_exp('Evasion')
      ...
      # @param name [String] The name of the skill.
      # @param new_exp [Integer] The new experience value for the skill.
      # @return [void]
      # @example
      #   DRSkill.handle_exp_change('Evasion', 150)
      ...
      # @param name [String] The name of the skill.
      # @param rank [Integer] The new rank modifier for the skill.
      # @return [void]
      # @example
      #   DRSkill.update_mods('Evasion', 2)
      def self.update_mods(name, rank)
        self.exp_modifiers[self.lookup_alias(name)] = rank.to_i
      end

      # Returns the current experience modifiers for skills.
      # @return [Hash] A hash of skill names and their experience modifiers.
      # @example
      #   modifiers = DRSkill.exp_modifiers
      def self.exp_modifiers
        @@exp_modifiers
      end

      # Clears the experience points for a skill.
      # @param val [String] The name of the skill to clear.
      # @return [void]
      # @example
      ...
      # @example
      #   mod_rank = DRSkill.getmodrank('Evasion')
      ...
      # @example
      #   xp = DRSkill.getxp('Evasion')
      def self.getxp(val)
        skill = self.find_skill(val)
        skill.exp.to_i
      end

      # Returns the percentage to the next rank of a specified skill.
      # @param val [String] The name of the skill.
      # @return [Integer] The percentage to the next rank (0 to 100).
      # @example
      ...
      # @example
      #   skillset = DRSkill.getskillset('Evasion')
      ...
      # @param skill [String] The name of the skill to look up.
      # @return [String] The canonical name of the skill.
      # @example
      #   canonical_name = DRSkill.lookup_alias('Inner Fire')
