module Lich
  module DragonRealms
    ...
    class SlackBot
      ...
      # @return [SlackBot] The instance of SlackBot.
      def initialize
      ...
      # @example
      #   bot.authed?(UserVars.slack_token)
      def authed?(token)
        params = { 'token' => token }
      ...
      # @note This method will block until a response is received or the timeout is reached.
      ...
      # @return [Net::HTTPResponse] The response from the Slack API.
      # @example
      #   bot.direct_message('john_doe', 'Hello there!')
      ...
      # @return [String] The channel ID for direct messaging.
      # @example
