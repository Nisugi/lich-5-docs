# Lich module
# This module contains utility functions for the Lich project.
module Lich
  # Util module
  # Provides utility functions for the Lich project.
  module Util
    # Magicinfo module
    # Handles magic-related information and commands.
    ...
    module Magicinfo
      ...
      # @param type [String] The type of request (default is 'announce').
      # @return [void]
      # @raise [StandardError] If the command type is invalid.
      # @example Requesting to announce magic information
      #   Lich::Util::Magicinfo.request('announce')
      ...
      # Clears active spells or a specific spell from the list.
