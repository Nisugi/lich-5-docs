...
module Lich
  module Gemstone
    ...
    class Society
      ...
      #   status = Lich::Gemstone::Society.membership
      def self.membership
      ...
      #   - "Guardians of Sunfist"
      #   - or `nil`/"None" if not a member
      # @example Checking society status
      ...
      #   - "You are not currently in a society."
      #   - "It is your eternal duty to release undead creatures..." (Voln masters)
      # @example Retrieving current task
      #   current_task = Lich::Gemstone::Society.task
      def self.task
      ...
      #
      # @return [Array<(String, Integer)>] An array in the format `[status, rank]`
      # @example Serializing society information
      #   info = Lich::Gemstone::Society.serialize
      def self.serialize
      ...
      #
      # @return [String] The current society membership
      # @example Getting deprecated membership status
      ...
      #
      # @return [Integer] The amount of Voln favor
      # @example Getting deprecated Voln favor
      ...
      #   resolved_value = Lich::Gemstone::Society.resolve(lambda { 42 })
