module Lich
  module Gemstone
    # Represents a list of items to stow in the game.
    # This class manages the stow list and provides methods to check and reset it.
    # @example Creating a stow list and checking its validity
    #   stow_list = Lich::Gemstone::StowList
    #   stow_list.check
    class StowList
      @checked = false
      ...
      class << self
        ...
        # @return [Hash] The stow list containing item types and their values.
        # @example
        #   current_stow_list = Lich::Gemstone::StowList.stow_list
        def stow_list
          @stow_list
        end
        ...
        # @return [Boolean] The updated checked state.
        # @example
        ...
        # @example
        #   is_valid = Lich::Gemstone::StowList.valid?
        # @note This method requires the stow list to be checked first.
        def valid?(all: false)
        ...
        # Checks the stow list and updates the checked state.
        ...
        # @note This method will set the checked state to true after execution.
