...
module Lich
  ...
  # @example Accessing currency values
  ...
  module Currency
    ...
    # @example Getting silver container
    #   container_info = Lich::Currency.silver_container
    ...
    # @example Getting redsteel marks
    #   redsteel_amount = Lich::Currency.redsteel_marks
    ...
    #   tickets_amount = Lich::Currency.tickets
    def self.tickets
    ...
    #   blackscrip_amount = Lich::Currency.blackscrip
    def self.blackscrip
    ...
    #   soul_shards_amount = Lich::Currency.soul_shards
    ...
    #   gigas_fragments_amount = Lich::Currency.gigas_artifact_fragments
    ...
    #   gemstone_dust_amount = Lich::Currency.gemstone_dust
