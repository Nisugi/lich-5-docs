...
# Contains various submodules and functionalities.
module Lich
  # Module for DragonRealms functionalities
  # @example Including DragonRealms
  #   include Lich::DragonRealms
  module DragonRealms
    # DRC module for DragonRealms commands and utilities
    ...
    module DRC
      ...
      # the calling script.
      # Sends a message and waits for a response with retries.
      # @param message [String] The message to send.
      # @param matches [Array<Regexp, String>] Patterns to match against responses.
      # @return [String] The first matching response or an empty string if no match is found.
      # @raise [Timeout::Error] If the operation times out.
      # @example
      #   response = DRC.bput('look', /You see/, /You don't see/)
      ...
      # Waits for a script to finish executing.
      ...
      # @return [Object] The handle of the script if it started successfully.
      # @example
      ...
      # @param practice [Boolean] Whether to practice collecting.
      # @return [void]
      # @example
      #   DRC.collect('flowers')
      ...
      # Rummages through a container for items.
      ...
      # Converts a game formatted list into an array.
      # @param list [String] The formatted list string.
      # @return [Array<String>] An array of items from the list.
      # @example
      ...
      # Converts a box formatted list into an array of adjectives and nouns.
      # @param list [String] The formatted list string.
      # @return [Array<String>] An array of items from the list.
      # @example
      ...
      # Converts a scroll formatted list into an array of adjectives and nouns.
      # @param list [String] The formatted list string.
      # @return [Array<String>] An array of items from the list.
      # @example
      #   scrolls = DRC.scroll_list_to_adj_and_noun('a scroll of fireball and a scroll of healing')
      ...
      # Converts a list into an array of nouns.
      # @param list [String] The formatted list string.
      # @return [Array<String>] An array of nouns from the list.
      # @example
      ...
      class Item
        ...
        # @param leather [Boolean] Whether the item is leather.
        # @param worn [Boolean] Whether the item is worn.
        # @param hinders_locks [Boolean] Whether it hinders lockpicking.
        # @param container [String] The container type.
        # @param swappable [Boolean] Whether the item is swappable.
        # @param tie_to [String] The item it is tied to.
        # @param adjective [String] An adjective for the item.
        ...
        # @param transform_text [String] The text shown when it transforms.
        # @param transform_verb [String] The verb used for transformation.
        # @param lodges [Boolean] Whether it lodges.
        # @param skip_repair [Boolean] Whether to skip repair.
        # @param ranged [Boolean] Whether the item is ranged.
        # @param needs_unloading [Boolean] Whether it needs unloading.
        ...
        # Returns a regex for matching the short name of the item.
        # @return [Regexp] The regex for the short name.
        # @example
        ...
        # @param noun [String] The noun of the item.
        # @return [Boolean] True if it is a ranged weapon, false otherwise.
        # @example
        #   if item.ranged_weapon?('bow')
        #     puts 'It is a ranged weapon.'
        #   end
        ...
        # Parses an item from its text representation.
        # @param text [String] The text representation of the item.
        # @return [Item, nil] The parsed Item instance or nil if parsing fails.
        # @example
      ...
      # Looks up the canonical name of a town based on the given text.
      ...
      # @example
      #   if DRC.listen?('teacher_name')
      #     puts 'You are listening.'
      #   end
      ...
      # Retreats from combat.
      # @param ignored_npcs [Array] List of NPCs to ignore during retreat.
      # @return [void]
      # @example
      ...
      # Plays a song using the specified settings.
      ...
      # @example
      #   DRC.play_song?(settings, song_list)
      ...
      # Cleans the instrument being used.
      ...
      # Performs the tuning action on the instrument.
      # @param instrument [String] The name of the instrument to tune.
      # @param tuning [String] The tuning adjustment to make.
      # @return [Boolean] True if tuning was successful, false otherwise.
      # @example
      #   DRC.do_tune('lute')
      ...
      # @param scripts_to_unpause [Array<String>] The names of scripts to unpause.
      # @return [void]
      # @example
      #   DRC.unpause_all_list(['script1', 'script2'])
      ...
      # @return [void]
      # @example
      #   DRC.safe_unpause_list(['script1', 'script2'])
      ...
      # Sets the player's stance based on skill.
      ...
      # @param make_bold [Boolean] Whether to make the message bold.
      # @return [void]
      # @example
      #   DRC.atmo('The sky is clear.')
      ...
      # @param pre_clear_window [Boolean] Whether to clear the window before sending the message.
      # @return [void]
      # @example
      #   DRC.log_window('Hello World', 'chat', true)
      ...
      # Wraps text in markup to render it as bold.
