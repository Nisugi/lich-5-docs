...
module Lich
  # Namespace for Gemstone functionalities
  # This module contains functionalities related to Gemstone within the Lich project.
  module Gemstone
    # Module for handling skills in the Gemstone system
    # This module provides methods to calculate bonuses and manage skills.
    # @example Accessing a skill bonus
    #   bonus = Skills.to_bonus(5)
    module Skills
      ...
      # @example Calculating bonus from ranks
      #   bonus = Skills.to_bonus(10)
      #   bonus = Skills.to_bonus(:combat_maneuvers)
      #   bonus = Skills.to_bonus('combat_maneuvers')
      ...
      # List of all skills available in the Gemstone system
      # This constant holds the symbols representing various skills.
