...
# @param cli_vars [Array<String>] The command line variables to pass to the script.
...
# @param code [Proc] The code block to execute.
# @return [void]
# @example
...
# Retrieves data from the upstream if the current script is set to receive it.
# @return [String, false] The upstream data or false if not set to receive.
# @example
#   upstream_get
def upstream_get
...
# @return [Boolean] True if set to receive, false otherwise.
# @example
#   upstream_get?
def upstream_get?
  unless (script = Script.current) then echo 'upstream_get: cannot identify calling script.'; return nil; end
...
# Checks if the character is really bleeding (not under spell effects).
...
# @return [Boolean] The new downstream setting.
# @example
#   i_stand_alone
def i_stand_alone
...
# @return [String, nil] The response string or nil on timeout.
# @example
#   selectput('command', ['success'], ['failure'])
...
# @param values [Array<String>] The values to send, with the first being the target script name.
...
# Sends values uniquely to a specified script.
# @param values [Array<String>] The values to send, with the first being the target script name.
# @return [Boolean] True if sent successfully, false otherwise.
# @example
...
# Waits for a line from the unique buffer that matches the provided strings.
# @param strings [Array<String>] The strings to match against.
# @return [String] The matching line.
# @example
#   unique_waitfor('pattern1', 'pattern2')
...
# Moves the character in multiple directions.
# @param dirs [Array<String>] The directions to move.
# @return [void]
# @example
...
# Returns the string representation of the north direction.
# @return [String] 'north'
# @example
#   n
def n;    'north';     end

# Returns the string representation of the northeast direction.
# @return [String] 'northeast'
# @example
#   ne
def ne;   'northeast'; end

# Returns the string representation of the east direction.
# @return [String] 'east'
# @example
#   e
def e;    'east';      end

# Returns the string representation of the southeast direction.
# @return [String] 'southeast'
# @example
#   se
def se;   'southeast'; end

# Returns the string representation of the south direction.
# @return [String] 'south'
# @example
#   s
def s;    'south';     end

# Returns the string representation of the southwest direction.
# @return [String] 'southwest'
# @example
#   sw
def sw;   'southwest'; end

# Returns the string representation of the west direction.
# @return [String] 'west'
# @example
#   w
def w;    'west';      end

# Returns the string representation of the northwest direction.
# @return [String] 'northwest'
# @example
#   nw
def nw;   'northwest'; end

# Returns the string representation of the up direction.
# @return [String] 'up'
# @example
#   u
def u;    'up';        end
...
# Returns the string representation of the down direction.
# @return [String] 'down'
# @example
#   down
def down; 'down';      end
...
# Returns the string representation of the out direction.
# @return [String] 'out'
# @example
#   o
def o;    'out';       end
...
# @param giveup_lines [Integer] The number of lines to read before giving up.
# @return [Boolean, nil] True if moved successfully, false if failed, nil if direction shouldn't be removed from the map database.
# @example
#   move('north')
...
# Monitors the character's health and executes a block when health drops below a specified value.
# @param value [Integer] The health value to monitor.
# @param theproc [Proc] Optional procedure to execute.
# @param &block [Proc] Optional block to execute.
# @return [void]
# @example
...
# Checks available paths in the specified direction.
# @param dir [String] The direction to check.
# @return [Array<String>, Boolean] The available paths or false if none.
# @example
#   checkpaths('north')
...
# Runs the walk method in a loop until completion.
# @return [void]
# @example
#   run
def run
...
# @return [Boolean, String] True if matches, or the mind text if no argument is provided.
# @example
#   check_mind('clear')
...
# @return [Boolean, Integer] The mind value or true if above the specified number.
# @example
#   percentmind(50)
...
# @param num [Integer, nil] Optional number to compare against.
# @return [Boolean, Integer] The mana value or true if above the specified number.
# @example
#   checkmana(50)
...
# Retrieves the maximum mana value for the character.
...
# @param num [Integer, nil] Optional number to compare against.
# @return [Boolean, Integer] The mana percentage or true if above the specified number.
# @example
#   percentmana(50)
...
# @param num [Integer, nil] Optional number to compare against.
# @return [Boolean, Integer] The health value or true if above the specified number.
# @example
#   checkhealth(50)
...
# Retrieves the maximum health value for the character.
...
# @param num [Integer, nil] Optional number to compare against.
# @return [Boolean, Integer] The health percentage or true if above the specified number.
# @example
#   percenthealth(50)
...
# @param num [Integer, nil] Optional number to compare against.
# @return [Boolean, Integer] The spirit value or true if above the specified number.
# @example
#   checkspirit(50)
...
# Retrieves the maximum spirit value for the character.
...
# @param num [Integer, nil] Optional number to compare against.
# @return [Boolean, Integer] The spirit percentage or true if above the specified number.
# @example
#   percentspirit(50)
...
# @param num [Integer, nil] Optional number to compare against.
# @return [Boolean, Integer] The stamina value or true if above the specified number.
# @example
#   checkstamina(50)
...
# Retrieves the maximum stamina value for the character.
...
# @param num [Integer, nil] Optional number to compare against.
# @return [Boolean, Integer] The stamina percentage or true if above the specified number.
# @example
#   percentstamina(50)
...
# Retrieves the maximum concentration value for the character.
...
# @param num [Integer, nil] Optional number to compare against.
# @return [Boolean, Integer] The concentration percentage or true if above the specified number.
# @example
...
# Checks the character's stance value.
# @param num [Integer, nil] Optional number to compare against.
# @return [Boolean, String] The stance value or true if matches the specified number.
# @example
#   checkstance(50)
...
# @param num [Integer, nil] Optional number to compare against.
# @return [Boolean, Integer] The stance percentage or true if above the specified number.
# @example
#   percentstance(50)
...
# @param string [String, Integer, nil] Optional string or number to compare against.
# @return [Boolean, String] The encumbrance value or true if matches the specified number.
# @example
#   checkencumbrance('light')
...
# @param num [Integer, nil] Optional number to compare against.
# @return [Boolean, Integer] The encumbrance percentage or true if above the specified number.
# @example
#   percentencumbrance(50)
...
# Checks the area description against provided strings.
# @param strings [Array<String>] The strings to check against.
# @return [String, Boolean] The area title or true if matches.
# @example
#   checkarea('forest', 'mountain')
...
# Checks the familiar area description against provided strings.
# @param strings [Array<String>] The strings to check against.
# @return [String, Boolean] The familiar area title or true if matches.
# @example
#   checkfamarea('forest', 'mountain')
...
# Checks the familiar room exits in the specified direction.
# @param dir [String] The direction to check.
# @return [Array<String>, Boolean] The familiar room exits or false if none.
# @example
#   checkfampaths('north')
...
# Checks the familiar NPCs against provided strings.
# @param strings [Array<String>] The strings to check against.
# @return [Array<String>, Boolean] The list of familiar NPCs or false if none.
# @example
...
# Checks the familiar PCs against provided strings.
# @param strings [Array<String>] The strings to check against.
# @return [Array<String>, Boolean] The list of familiar PCs or false if none.
# @example
#   checkfampcs('hero', 'warrior')
...
# Checks the PCs in the game against provided strings.
# @param strings [Array<String>] The strings to check against.
# @return [Array<String>, Boolean] The list of PCs or false if none.
# @example
#   checkpcs('player1', 'player2')
...
# Checks the NPCs in the game against provided strings.
# @param strings [Array<String>] The strings to check against.
# @return [Array<String>, Boolean] The list of NPCs or false if none.
# @example
#   checknpcs('goblin', 'troll')
...
# @param hand [Array<String>] The items to check for.
...
# Checks the room description against provided strings.
# @param val [Array<String>] The strings to check against.
...
# @example
#   checkfamroomdescrip('bright', 'cheerful')
...
# @return [Boolean, String] True if prepared, or the prepared spell name if no argument is provided.
# @example
#   checkprep('fireball')
...
# @param val [Integer, nil] The priority value to set.
# @return [Integer] The current priority if no argument is provided.
# @example
#   setpriority(2)
...
# @param results_of_interest [Object, nil] Optional results to consider.
# @return [Boolean] True if cast successfully, false otherwise.
# @example
...
# @return [Array<String>] The cleared messages.
# @example
#   clear
def clear(_opt = 0)
...
# Matches a line from the script's input against provided strings.
# @param label [String] The label to match against.
# @param string [String] The string to match.
# @return [String, nil] The matched string or nil if not found.
# @example
#   match('label', 'string')
...
# Matches a line from the script's input with a timeout.
# @param secs [Numeric] The timeout duration in seconds.
# @param strings [Array<String>] The strings to match against.
# @return [String, nil] The matched string or nil if timeout occurs.
# @example
#   matchtimeout(5, 'pattern')
...
# Matches a line from the script's input that contains both specified strings.
# @param strings [Array<String>] The strings to match against.
# @return [Array<String>] The matched strings.
# @example
#   matchboth('pattern1', 'pattern2')
...
# Waits for the next line from the script's input.
...
# Retrieves the next line from the script's input.
# @return [String] The next line.
# @example
#   get
def get
...
# Checks if there is a line available in the script's input.
# @return [Boolean] True if available, false otherwise.
# @example
#   get?
def get?
...
# @param waitingfor [Array<String>] Optional responses to wait for.
# @return [String, nil] The response string or nil if not found.
# @example
#   fput('command', ['success'])
...
# Matches a line from the script's input against provided strings exactly.
# @param strings [Array<String>] The strings to match against.
# @return [String, nil] The matched string or nil if not found.
# @example
#   matchfindexact('label', 'string')
...
# Matches a word from the script's input against provided strings.
# @param strings [Array<String>] The strings to match against.
# @return [String, nil] The matched word or nil if not found.
# @example
#   matchfindword('word')
...
# @param onoff [String] The state to set ('on' or 'off').
# @return [void]
# @example
#   status_tags('on')
...
# Calculates the pulse for a non-noded character.
...
# Calculates the pulse for a noded character.
# @return [Integer] The calculated pulse value.
# @example
#   unnoded_pulse
def unnoded_pulse
...
# Executes a specified action and waits for a success response.
# @param action [String] The action to perform.
# @param success_line [Regexp] The success response to match.
# @return [void]
# @example
#   dothis('move north', /success/)
...
# Executes a specified action with a timeout for success response.
# @param action [String] The action to perform.
# @param timeout [Numeric] The timeout duration in seconds.
# @param success_line [Regexp] The success response to match.
# @return [void]
# @example
#   dothistimeout('move north', 5, /success/)
