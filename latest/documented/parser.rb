    ...
    module Infomon
      ...
      module Parser
        module Pattern
          ...
          # Regex pattern for fame parsing
          ...
          # Regex pattern for individual skill parsing
          ...
          # Regex pattern for the end of skill goals updates
          ...
          # Regex pattern for society membership parsing
          ...
          # Regex pattern for no society membership parsing
          ...
          # Regex pattern for suffused resource parsing
          ...
          # Regex pattern for profile house parsing
          ...
          # Regex pattern for resigning from a house parsing
          ...
          # Regex pattern for silence active state parsing
          ...
          # Regex pattern for thorn poison start state parsing
          ...
          # Regex pattern for thorn poison progression state parsing
          ...
          # Regex pattern for thorn poison deprogression state parsing
          ...
          # Regex pattern for spellsong renewal
          ...
          All = Regexp.union(CharRaceProf, CharGenderAgeExpLevel, Stat, StatEnd, Fame, RealExp, AscExp, TotalExp, LTE,
                             ...
                             # Regex pattern for bind active state parsing
                             # Regex pattern for sleep active state parsing
                             Citizenship, NoCitizenship, Society, NoSociety, SleepActive, SleepNoActive, BindActive,
                             # Regex pattern for cutthroat active state parsing
                             # Regex pattern for calm inactive state parsing
                             # Regex pattern for bind inactive state parsing
                             ...
                             # Regex pattern for thorn poison end state parsing
        ...
        def self.parse(line)
          ...
          begin
            ...
            when Pattern::SleepActive
              ...
              :ok
            # Regex pattern for sleep inactive state parsing
            ...
            when Pattern::CutthroatActive
              ...
              :ok
            # Regex pattern for cutthroat inactive state parsing
