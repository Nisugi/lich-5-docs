module Lich
  module Common
    class Map
      ...
      # @param uid [Array<Integer>] The unique identifiers associated with the map (default: []).
      ...
      # @param wayto [Hash<String, String>] The connections to other rooms (default: {}).
      # @param timeto [Hash<String, Float>] The time to travel to other rooms (default: {}).
      # @param image [String, nil] The image associated with the map (default: nil).
      # @param image_coords [Array<Integer>, nil] The coordinates for the image (default: nil).
      # @param tags [Array<String>] The tags associated with the map (default: []).
      # @param check_location [String, nil] A check for the location (default: nil).
      # @param unique_loot [String, nil] Unique loot associated with the map (default: nil).
      # @param _room_objects [Array] Room objects associated with the map (default: nil).
      ...
      # @return [Integer] The unique identifier of the map.
      # @example
      #   map_id = map.to_i
      def to_i
        @id
      ...
      # Returns a string representation of the map's instance variables.
      # @return [String] A string detailing the instance variables of the map.
      def inspect
        self.instance_variables.collect { |var| var.to_s + "=" + self.instance_variable_get(var).inspect }.join("\n")
      end

      # Retrieves a free ID for a new map instance.
      # @return [Integer] A unique ID that is not currently in use.
      # @example
      #   new_id = Map.get_free_id
      def Map.get_free_id
      ...
      # @return [Array<Map>] An array of all map instances.
      # @example
      #   all_maps = Map.list
      def Map.list
        Map.load unless @@loaded
      ...
      # @return [Map, nil] The map instance if found, otherwise nil.
      # @example
      #   specific_map = Map[1]
      def Map.[](val)
        Map.load unless @@loaded
      ...
      # Returns the previously accessed map.
      # @return [Map, nil] The previous map instance if available, otherwise nil.
      def Map.previous
        return @@list[@@previous_room_id]
      end

      # Returns the UID of the previously accessed map.
      # @return [Integer, nil] The UID of the previous map if available, otherwise nil.
      def Map.previous_uid
        return XMLData.previous_nav_rm
      end

      # Returns the current map based on the game state.
      # @return [Map, nil] The current map instance if available, otherwise nil.
      ...
      # Matches the current map without a UID.
      # @return [Map, nil] The matched map instance if found, otherwise nil.
      ...
      # Sets the current map to a fuzzy match.
      # @param id [Integer] The ID of the map to set as current.
      # @return [Map, nil] The newly set map instance if found, otherwise nil.
      ...
      # Matches the current map based on the game script.
      # @return [Integer, nil] The ID of the matched map if found, otherwise nil.
      ...
      # Matches a map based on fuzzy criteria.
      # @return [Integer, nil] The ID of the matched map if found, otherwise nil.
      ...
      # Returns the current map or creates a new one if none exists.
      # @return [Map, nil] The current map instance or a new map if created.
      ...
      # @param id [Integer] The map ID associated with the UID.
      ...
      # @return [Integer, nil] The matched ID if found, otherwise nil.
      ...
      # Returns the unique tags from all maps.
      ...
      # Loads UIDs from the map list into the UID mapping.
      # @return [void]
      def Map.load_uids()
        Map.load unless @@loaded
        @@uids.clear
      ...
      # @return [Array<Integer>] An array of map IDs associated with the UID.
      def Map.ids_from_uid(n)
        return (@@uids[n].nil? || n == 0 ? [] : @@uids[n])
      end

      # Clears the map data and resets the state.
      # @return [Boolean] Returns true if the clear operation was successful.
      def Map.clear
      ...
      # Loads map data from a specified file or directory.
      ...
      # Saves the current map data to a specified file.
      ...
      # @raise [MapError] If the input is not an array.
      ...
      # @param source [Map, Integer] The source map or room ID.
      # @param destination [Integer, nil] The destination room ID (default: nil).
      # @return [Array, Array] The previous rooms and shortest distances.
      ...
      # Performs Dijkstra's algorithm for the current map instance.
      # @param destination [Integer, nil] The destination room ID (default: nil).
      # @return [Array, Array] The previous rooms and shortest distances.
      ...
      # Finds a path from the source to the destination.
      # @param source [Map, Integer] The source map or room ID.
      # @param destination [Integer] The destination room ID.
      # @return [Array, nil] The path as an array of room IDs, or nil if no path exists.
      ...
      # Finds a path to the specified destination.
      # @param destination [Integer] The destination room ID.
      # @return [Array, nil] The path as an array of room IDs, or nil if no path exists.
      ...
      # @param tag_name [String] The tag to search for.
      # @return [Array<Integer>] An array of room IDs sorted by distance.
    ...
    # Inherits from Map and provides additional functionality.
    # @example Creating a room
    #   room = Lich::Common::Room.new(id, title, description, paths)
    class Room < Map
    ...
    # deprecated
    # Deprecated class for Map.
    # Provides legacy methods for accessing map properties.
    class Map
      # Returns the description of the map.
      # @return [Array<String>] The description of the map.
      def desc
        @description
      end

      # Returns the name of the map image.
      # @return [String, nil] The name of the map image if available.
      def map_name
        @image
      end

      # Returns the X coordinate of the map image.
      # @return [Integer, nil] The X coordinate if available.
      def map_x
        if @image_coords.nil?
          nil
        else
      ...
      # @return [Integer, nil] The Y coordinate if available.
      def map_y
        if @image_coords.nil?
          nil
        else
      ...
      # @return [Integer, nil] The size of the room if available.
      def map_roomsize
        if @image_coords.nil?
          nil
        else
      ...
      # Returns geographical information about the map.
