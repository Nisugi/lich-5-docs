...
module Lich
  # Provides common GUI login functionalities for the Lich application.
  ...
  module Common
    ...
    # @return [Object] Launch data or exits the application if not available.
    # @example Executing the GUI login
    #   Lich::Common.gui_login
    def gui_login
    ...
    # Sets up the main GUI window, including message dialogs and tab instances.
    # @note This method is called during the login process to initialize the GUI.
    # @return [void]
    ...
    # Configures communication between different tabs in the GUI.
    # @return [void]
    ...
    # Creates instances of the saved login and manual login tabs, setting up their callbacks.
    # @return [void]
    ...
    # Initializes the notebook widget that holds the different tabs for the GUI.
    # @return [void]
    def setup_notebook
    ...
    # Configures the properties of the main application window, including title and icon.
    # @return [void]
    ...
    # Applies a specific style to buttons when the application is in light mode.
    # @return [void]
    ...
    # Applies a specified style to all buttons in the given UI elements.
    # @param ui_elements [Hash] The UI elements containing buttons to style.
    ...
    # Hides optional UI elements based on the current state of the application.
    # @return [void]
    ...
    # Saves entry data if it has been marked for saving.
    # @return [void]
    ...
    # Returns the launch data if available, or exits the application.
    # @return [Object] Launch data or exits the application.
