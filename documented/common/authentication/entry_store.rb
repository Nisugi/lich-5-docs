...
module Lich
  ...
  # This module contains authentication-related methods and data handling.
  # @example Including the module
  #   include Lich::Common
  module Common
    module Authentication
      module EntryStore
        # Returns the path to the YAML file for entry storage.
        # @param data_dir [String] The directory where the YAML file is stored.
        ...
        # @return [Array] An array of loaded entries.
        ...
        # Saves the provided entry data to the YAML file.
        # @param data_dir [String] The directory where the YAML file is stored.
        ...
        # Encrypts the given password using the specified mode.
        ...
        # Decrypts the given encrypted password using the specified mode.
        ...
        # Attempts to decrypt the password, with recovery options if the master password is missing.
        # @param encrypted_password [String] The encrypted password to decrypt.
        # @param mode [Symbol] The encryption mode used for the password.
        # @param account_name [String, nil] The account name associated with the password.
        # @param master_password [String, nil] The master password for decryption.
        ...
        # Encrypts all passwords in the provided YAML data.
        ...
        # Changes the encryption mode for the stored passwords.
        # @param data_dir [String] The directory where the YAML file is stored.
        ...
        # Migrates the YAML data to include encryption format information.
        ...
        # @param data_dir [String] The directory where the YAML file is stored.
        # @param ordered_favorites [Array] An array of favorite character information with the new order.
        ...
        # @return [Array] An array of entries in legacy format.
        ...
        # Migrates the YAML data to include favorite status for characters.
        # @param yaml_data [Hash] The YAML data to migrate.
        # @return [Hash] The migrated YAML data.
        ...
        # Retrieves the next available order number for favorites.
        # @param yaml_data [Hash] The YAML data containing accounts and characters.
        ...
        # Normalizes the account name to a standard format.
        ...
        # Normalizes the character name to a standard format.
        ...
        # @param yaml_data [Hash] The YAML data to convert to content.
        ...
        # Writes the YAML data to a file with secure permissions.
