...
module Lich
  module Common
    module GUI
      module Components
        # Creates a button with an optional label and CSS provider.
        ...
        # Creates a labeled entry field with an optional password mode.
        ...
        #   entry = Lich::Common::GUI::Components.create_labeled_entry("Username")
        ...
        # Creates a notebook widget with the specified pages.
        # @param pages [Array<Hash>] An array of pages, each containing a label and a widget.
        ...
        #   notebook = Lich::Common::GUI::Components.create_notebook([{ label: "Page 1", widget: widget1 }, { label: "Page 2", widget: widget2 }])
