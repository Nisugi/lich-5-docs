...
=end
        # A hash containing ranged weapon statistics indexed by weapon identifiers.
        # Each entry includes details such as category, base name, all names, damage types,
        # damage factors, armor avoidance by armor size group (ASG), base roundtime (RT),
        # minimum RT, and weapon class.
        # @example Accessing weapon stats
        #   stats = Lich::Gemstone::Armaments::WeaponStats.weapon_stats_ranged[:composite_bow]
        @@weapon_stats_ranged = {
          :composite_bow  => {
            :category      => :ranged,
